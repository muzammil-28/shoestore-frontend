...
function OrderDetail() {
    ...
    useEffect(() => {
        fetch(`http://localhost/Projects/ShoeStore-project/shoestore-backend/api/order-detail.php?order_id=${orderDetailId}`)
        .then(res => res.json())
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between border rounded-lg p-4 bg-gray-50">
                        <div className="flex items-center gap-4">
                            <img src={`http://localhost/Projects/ShoeStore-project/shoestore-backend/uploads/image/${orderDetail.image}`} alt="Product" className="w-16 h-16 rounded" />
                            <div>
