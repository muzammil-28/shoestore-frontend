...
function Dashboard() {
  ...
  const fetchData = async (tab) => {
    ...
    switch (tab) {
      case "products":
        url = `http://localhost/Projects/ShoeStore-project/shoestore-backend/api/admin/admin-products.php`;
        break;
      case "orders":
        url = `http://localhost/Projects/ShoeStore-project/shoestore-backend/api/admin/admin-orders.php`;
        break;
      case "users":
        url = `http://localhost/Projects/ShoeStore-project/shoestore-backend/api/admin/admin-users.php`;
        break;
      case "categories":
        url = `http://localhost/Projects/ShoeStore-project/shoestore-backend/api/admin/admin-categories.php`;
        break;
      default:
        url = "";
    }
