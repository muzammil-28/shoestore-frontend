...
function Checkout() {
    ...
    useEffect(() => {
        fetch(`http://localhost/Projects/ShoeStore-project/shoestore-backend/api/checkout.php?type=${type}&id=${id}`, {credentials : "include"})
        .then(res => res.json())
    ...
    const handlePlaceOrder = async () => {
        const orderRes = await fetch(
            `http://localhost/Projects/ShoeStore-project/shoestore-backend/api/place-order.php`,
            {
                method : "POST",
